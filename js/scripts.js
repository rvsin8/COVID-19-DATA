  ...
  const cardsGroupData = [
    {
      ...
      icon: "fas fa-users",
      title: "Total Cases",
      count: `${formatter.format(statData.cases)}`,
    },
    {
      id: 2,
      icon: "fas fa-users",
      title: "Today Cases",
      count: `${formatter.format(statData.todayCases)}`,
    },
    {
      id: 3,
      icon: "fas fa-procedures",
      title: "Total Deaths",
      count: `${formatter.format(statData.deaths)}`,
    },
    {
      id: 4,
      icon: "fas fa-procedures",
      title: "Today Deaths",
      count: `${formatter.format(statData.todayDeaths)}`,
    },
    {
      id: 5,
      icon: "fas fa-heart",
      title: "Total Recovered",
      count: `${formatter.format(statData.recovered)}`,
    },
    {
      id: 6,
      icon: "fas fa-heart",
      title: "Today Recovered",
      count: `${formatter.format(statData.todayRecovered)}`,
    },
    {
      id: 7,
      icon: "fas fa-heartbeat",
      title: "Total Active",
      count: `${formatter.format(statData.active)}`,
    },
    {
      id: 8,
      icon: "fas fa-hospital-user",
      title: "Critical",
      count: `${formatter.format(statData.critical)}`,
    },
    {
      id: 9,
      icon: "fas fa-vial",
      title: "Total Tests",
      count: `${formatter.format(statData.tests)}`,
    },
    {
      id: 10,
      icon: "fas fa-globe-europe",
      title: "Population",
      count: `${formatter.format(statData.population)}`,
    },
    {
      id: 11,
      icon: "fas fa-user-times",
      title: "Affected Countries",
      count: `${formatter.format(statData.affectedCountries)}`,
    },
